...
namespace ProjectManagement.DataAccess.Model.Migrations
{
    ...
    [Migration("20230515195028_ChangeOfArhitecture")]
    partial class ChangeOfArhitecture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectManagement.DataAccess.Model.Answer", b =>
                {
                    ...
                    b.HasOne("ProjectManagement.DataAccess.Model.User", "Teacher")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("ProjectManagement.DataAccess.Model.Question", b =>
                {
                    ...
                    b.HasOne("ProjectManagement.DataAccess.Model.User", "Student")
                        .WithMany("Questions")
